...
EOF;
			...
			function load_common_scripts() {
				...
				wp_enqueue_style( 'leaflet', TRACKSERVER_JSLIB . 'leaflet-0.7.7/leaflet.css' );
				wp_enqueue_script( 'leaflet', TRACKSERVER_JSLIB . 'leaflet-0.7.7/leaflet.js', array(), false, true );
