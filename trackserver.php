...
EOF;
		...
		function load_common_scripts() {
			...
			wp_enqueue_style( 'leaflet', TRACKSERVER_JSLIB . 'leaflet-1.5.1/leaflet.css' );
			wp_enqueue_script( 'leaflet', TRACKSERVER_JSLIB . 'leaflet-1.5.1/leaflet.js', array(), false, true );
